        ...
        <div className="flex items-center gap-6 relative">
          ...
          <div className="relative ">
            <button
              ...
              className="w-9 h-9 cursor-pointer bg-black text-white rounded-full flex items-center justify-center font-semibold"
            >
              {userData ? (
                userData.name ? (
            ...
            {showUserPopUp && (
              <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50">
                ...
                <button
                  ...
                  className="w-full text-sm py-2 hover:text-black text-gray-600"
                >
                  Interview History
                </button>
                <button
